...
class MemorystoreChatMessageHistory(BaseChatMessageHistory):
    ...
    def __init__(
        ...
        Args:
            client: A redis.Redis object that connects to the Redis instance.
            session_id: The session ID for this chat message history.
            ttl: The expiration time in seconds of the whole chat history after
                the most recent add_message was called.
        """
